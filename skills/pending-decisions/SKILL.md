...
- Finish with a one-screen summary: decided / deferred / newly unblocked work, and offer to dispatch the unblocked work per the `orchestrate` skill (this skill decides; it does not build).
